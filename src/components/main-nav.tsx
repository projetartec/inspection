...
export function MainNav({
  ...
  consultationSummary?: React.ReactNode;
}) {
          ...
          {isConsultationPage && consultationSummary && (
            <>
              ...
              <div className="p-2 space-y-2">
                <h4 className="px-2 text-xs font-medium text-sidebar-foreground/70">
                  Resumo da Consulta
                </h4>
                {consultationSummary}
              </div>
  ...
  const menuItems = [
    {
      href: `${buildingBasePath}/dashboard`,
      label: 'Painel do Prédio',
      icon: LayoutDashboard,
      iconUrl: null,
    },
    {
      href: `${buildingBasePath}/extinguishers`,
      label: 'Extintores',
      icon: null,
      iconUrl: 'https://i.imgur.com/acESc0O.png',
    },
    {
      href: `${buildingBasePath}/hoses`,
      label: 'Mangueiras',
      icon: null,
      iconUrl: 'https://i.imgur.com/Fq1OHRb.png',
    },
  ];
