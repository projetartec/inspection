...
export function generateXlsxReport(client: Client, building: Building, extinguishers: Extinguisher[], hoses: Hydrant[]) {
...
export function generateClientXlsxReport(client: Client, buildings: Building[]) {
     const wb = XLSX.utils.book_new();
